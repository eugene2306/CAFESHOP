...
namespace CafeShop
{
    public partial class RegisterForm : Form
    {
        ...
        SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""C:\Users\ADMIN\OneDrive - Trường Đại Học Kiến Trúc Hà Nội\Documents\cafe.mdf"";Integrated Security=True;Connect Timeout=30;Encrypt=True");
        public RegisterForm()
        {
            InitializeComponent();
        }
